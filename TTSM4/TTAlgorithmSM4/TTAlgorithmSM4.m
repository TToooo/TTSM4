...
@implementation TTAlgorithmSM4

+ (nullable instancetype)cbcSM4WithKey:(nonnull NSString *)secretKey iv:(nonnull NSString *)iv
{
    TTAlgorithmSM4 *cbcSM4 = [[TTAlgorithmSM4 alloc]initWithKey:secretKey iv:iv];
...
{
    TTAlgorithmSM4 *ecbSM4 = [[TTAlgorithmSM4 alloc]initWithKey:secretKey];
